...
class Updatepwd extends StatefulWidget {
  ...
  Updatepwd({required this.mid}); // Findpwd에서 받은  생성자 mid 비밀번호 를 final String mid에 저장
...
class StateUpdatepwd extends State<Updatepwd> {
  ...
  void updatepwd() async{
    try{
      ...
      final response = await dio.put("http://localhost:8080/api/member/findpwd" , data: obj);
