...
class MenuState extends State<Menu> {
  ...
  Widget _buildIconGrid(List<Widget> items, {int crossAxisCount = 4}) {
    ...
    for (int i = 0; i < items.length; i += crossAxisCount) {
      ...
      List<Widget> expandedRowItems = rowItems
              ...
              children: [
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        setState(() {
                          checkwishlist = !checkwishlist; // 편집
                        });
                      },
                      icon: Icon(checkwishlist ? Icons.star : Icons.star_border
                ...
                _buildIconGrid([
                  ...
                  checkStart(
                    ...
                    "CCTV",
                    () =>
                        Navigator.pushNamed(context, "/map", arguments: "cctv"),
                    Colors.red,
                    "CCTV",
                  ),
                ], crossAxisCount: 4),
