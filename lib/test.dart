// 무브온 로고자리에 현재위치 반영하는것
// import 'package:flutter/material.dart';
//
// class Menu extends StatefulWidget {
//   // ✨ 1. isHome 매개변수 추가: 이 위젯이 홈 화면에서 호출되었는지 여부를 결정
//   final bool isHome;
//
//   const Menu({Key? key, this.isHome = false}) : super(key: key); // 기본값은 false
//
//   @override
...
//   }
//
//   // ✨ 2. AppBar 제목 위젯을 조건부로 생성하는 함수
//   Widget _buildAppBarTitle() {
//     // isHome이 true(홈 화면)인 경우, 로고(mOveOn 텍스트) 표시
//     if (widget.isHome) {
//       return const Text(
//         'mOveOn',
//         style: TextStyle(
...
//       );
//     } else {
//       // isHome이 false(서브 페이지)인 경우, 현재 위치 정보 표시
//       return const Column(
