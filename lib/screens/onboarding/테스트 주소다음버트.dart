...
//   final Color _outlinedButtonColor = const Color(0xFF3DE0D2); // 이전 버튼의 테두리 및 텍스트 색상
//   final Color _nextButtonBgColor = Colors.yellow; // 다음 버튼의 배경색 (참고 코드의 노란색)
//   final Color _nextButtonTextColor = const Color(0xFF3DE0D2); // 다음 버튼의 텍스트 색상 (_mainTealColor)
//
//   @override
//   void initState() {
...
//                     // ⭐️ _outlinedButtonColor 사용
//                     side: BorderSide(color: _outlinedButtonColor, width: 2),
//                     foregroundColor: _outlinedButtonColor,
